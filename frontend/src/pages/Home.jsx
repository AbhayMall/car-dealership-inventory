        ...
        <div className="relative mx-auto grid min-h-[650px] max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-gray-400">
              ...
              Explore our curated inventory of quality vehicles,
              compare your options, and find your perfect car
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative mx-auto aspect-square max-w-lg">
              ...
              <div className="absolute inset-16 flex items-center justify-center rounded-3xl border border-gray-800 bg-gray-900 shadow-2xl">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-gray-600">
              We've designed the experience to make finding
              and managing vehicles simple.
            </p>
